# Neon :: WS Companion :: Version 1.5.0.0
## Project
...
Currently, all JavaScript is minified manually. Future versions will address this issue, but for now a developer will have to specify which code they want to compile at build time. In index.html, around line 120, instructions on how to this are provided. Obviously, any code written will not be automatically minified, and it's up to the developer to do that. Hopefully this will be fixed soon.
## Contact
For any official questions, you can email codeandconfusion [at] gmail [dot] com.
